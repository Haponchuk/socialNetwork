let state = {
    messagePage: {
        dialogData: [
            {id: 1, name: "Roma", profilePic: "https://nntheblog.b-cdn.net/wp-content/uploads/2022/02/Hisoka.jpg"},
            ...
            {id: 5, name: "Zheton", profilePic: "https://nntheblog.b-cdn.net/wp-content/uploads/2021/07/Emperor-time.jpg"},
            ...
            {id: 7, name: "Anton", profilePic: "https://pbs.twimg.com/profile_images/639616445417066497/hkxvFwvy_400x400.png"}
        ],
        messageData: [
            ...
            {id: 7, message: "Ех, от би першокурсниця показала кімнату"}
        ],
    },
    profilePage: {
        postData: [
